  ...
  final  String address = postAddress.getText().toString();
   final String code = zipCode.getText().toString();
    ...
    if(email.isEmpty() || password.isEmpty() || repeatPassword.isEmpty() || code.isEmpty() || address.isEmpty()){
        Toast.makeText(CreateAccountActivity.this, "Please enter non-empty values.", Toast.LENGTH_SHORT).show();
        return;
    }
    else if (code.length() != 5) {
        Toast.makeText(CreateAccountActivity.this, "Please enter your 5 digit post code.", Toast.LENGTH_SHORT).show();
        zipCode.requestFocus();
        return;
    }
    else if (password.length() < 8) {
        Toast.makeText(CreateAccountActivity.this, "Please enter at least 8 characters or numbers.", Toast.LENGTH_SHORT).show();
        createPassword.requestFocus();
        return;
    }
    else if(!password.equals(repeatPassword)) {
        Toast.makeText(CreateAccountActivity.this, "The re-entered password is incorrect.", Toast.LENGTH_SHORT).show();
        return;
        ...
        mAuth.createUserWithEmailAndPassword(email,password)
                .addOnCompleteListener(task ->  {
                    ...
                    if (task.isSuccessful()) {
                       Toast.makeText(CreateAccountActivity.this, "Account has been created successfully.", Toast.LENGTH_SHORT).show();
                        ...
                        startActivity(new Intent(CreateAccountActivity.this, CustomerLoginActivity.class));
                        }
         });
